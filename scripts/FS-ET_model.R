...
first <- read.csv("/home/paulohenrik/GIT-repository/eTZS_DecisionTrees_C50/datasets_1/first.csv")
first$BestFirst <- factor (first$BestFirst, levels = c("0", "1"), labels = c("no", "yes"))

set.seed(123)


sink("/home/paulohenrik/GIT-repository/eTZS_DecisionTrees_C50/fset.txt")
